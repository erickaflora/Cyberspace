...
export default function RegisterForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    const newErrors = {};
    const usernameError = registerValidation.username(username);
    ...
    const confirmPasswordError = registerValidation.confirmPassword(confirmPassword, password);
    ...
    if (result.success) {
      setToast({
        opened: true,
        message: 'DECRYPT_SUCCESS: Account registered. Access granted.',
        type: 'success',
      });
      setTimeout(() => navigate('/'), 1500);
    } else {
      setErrors({ form: result.error || 'Check details and try again.' });
    }
  };
